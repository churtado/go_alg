...
// A score includes each player's score and points scored by the current player
type score struct {
	player, opponent, thisTurn int
}

// An action transitions to a resulting score
type action func(current score) (result score, turnIsOver bool)

// roll returns the outcome of simulating a roll
